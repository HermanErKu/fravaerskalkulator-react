...
import Bygg from './yrkesfag/Bygg';
import Elektro from './yrkesfag/Elektro';
import Frisør from './yrkesfag/Frisør';
import Helse from './yrkesfag/Helse';
import Håndverk from './yrkesfag/Håndverk';
import IM from './yrkesfag/IM';
import Naturbruk from './yrkesfag/Naturbruk';
import Restaurant from './yrkesfag/Restaurant';
import Salg from './yrkesfag/Salg';
import TIF from './yrkesfag/TIF';
